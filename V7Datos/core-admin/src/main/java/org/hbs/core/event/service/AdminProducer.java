...
public class AdminProducer implements IPath
{
	...
	public void sendEmailMessage(ETemplate eTemplate, Object object)
	{
		...
		// this.kafkaTemplate.send(INTERNAL_TOPIC, ETopicPartition.Email.ordinal(),
		// eTemplate.name(), new Gson().toJson(object));
	}
	...
	public void sendSMSMessage(ETemplate eTemplate, Object object)
	{
		...
		// this.kafkaTemplate.send(INTERNAL_TOPIC, ETopicPartition.SMS.ordinal(), eTemplate.name(),
